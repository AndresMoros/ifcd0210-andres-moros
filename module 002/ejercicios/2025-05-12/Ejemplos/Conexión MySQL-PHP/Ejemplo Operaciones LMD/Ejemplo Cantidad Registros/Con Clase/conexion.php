	...
	class ConexionBD{
		...
		public function consultarBD($consulta){
			$this->resultado = mysqli_query($this->conexion,$consulta); // Realizar consultas. La variable $consulta cargará posteriormente la instrucción LMD que se quiera se ejecutar.
		}
		...
		public function cantidadOperaciones(){
