	...
	<?php
		...
		// Consultas.
			...
			//$consulta =	"select * from usuarios where codigo = '20A'";// Ejemplo de consulta con condiciones.
			//$consulta =	"select nombre, cuenta from usuarios;// Ejemplo de consulta con condiciones.
	?>
